    ...
    return (
        <>
            ...
            <div className="md:hidden md:h-0 w-[90%] m-auto bg-gradient-to-tr from-red-300/30 to-pink-300/30 flex items-center border-b-2 border-b-red-600 animate-blink_cursor">
                <p className="font-sans text-900 drop-shadow-md px-4 text-center">The app is designed to work on bigger screen like laptop or desktop computer. Please use one.</p>
            </div>
