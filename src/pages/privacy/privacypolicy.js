...
function PrivacyPolicy() {
    return (
        <div className="bg-white p-4">
            <h1 className="py-4 text-lg font-bold">Privacy Policy</h1>
            <p>
            ...
            <h2 className="py-4 text-lg font-bold">Interpretation</h2>
            <p>
            ...
            <h2 className="py-4 text-lg font-bold">Definitions</h2>
            ...
            <ul className="ml-8 list-item list-disc">
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to TypingChild,
                        accessible from{' '}
                        <a
                            href="https://www.typingchild.com"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://www.typingchild.com
                        </a>
                    </p>
                </li>
                <li>
            ...
            <h2 className="py-4 text-lg font-bold">Types of Data Collected</h2>
            <h3 className="py-4 text-lg font-bold">Personal Data</h3>
            <p>
            ...
            <h3 className="py-4 text-lg font-bold">Usage Data</h3>
            ...
            <h3 className="py-4 text-lg font-bold">Business Transactions</h3>
            <p>
            ...
            <h3 className="py-4 text-lg font-bold">Law enforcement</h3>
            <p>
            ...
            <h3 className="py-4 text-lg font-bold">Other legal requirements</h3>
            <p>
            ...
            <h1 className="py-4 text-lg font-bold">Children's Privacy</h1>
            <p>
            ...
            <h1 className="py-4 text-lg font-bold">Links to Other Websites</h1>
            <p>
            ...
            <h1 className="py-4 text-lg font-bold">Contact Us</h1>
            <p>
            ...
            <ul className="ml-8 list-item list-disc">
                <li>
                    By email:{' '}
                    <a
                        className="underlind text-blue-500"
                        href="mailto:jazzthumyat@gmail.com"
                    >
                        jazzthumyat@gmail.com
                    </a>
                </li>
            </ul>
        </div>
