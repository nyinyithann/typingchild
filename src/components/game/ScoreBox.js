...
function ScoreBox({level, xp, levelXP}) {
    return (
        <div
            role="score"
            className="border-primary bg-primary flex w-fit items-center justify-center space-x-4 rounded-md px-2 py-1 text-900 text-base"
        >
            <span className="text-top align-text-top text-600">Level</span>
            <span className="border-secondary bg-secondary inline-block rounded-md p-1 px-2 text-right text-600 md:w-[6rem]">
                {level}
            </span>
            <span className="text-top align-text-top text-600">Points</span>
            <div className="border-secondary bg-secondary rounded-md p-1 md:w-[10rem] flex items-center justify-end">
