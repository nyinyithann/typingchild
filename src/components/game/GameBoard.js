            ...
            <div className="grid auto-rows-min content-center gap-4 px-4 md:px-[4rem] xl:px-[16rem] 2xl:px-[22rem]">
                ...
                </div>
                {
                    getMode(selectedLesson.content) === LETTER_MODE
                        ? <LetterTypingBoard ref={keyEventRef} lessonId={selectedLesson.id} lessonBonusPoints={selectedLesson.bonusPoints} lessonLines={letterLessonLines} notifyLessonEnd={notifyLessonEnd} />
                        : <ParagraphTypingBoard ref={keyEventRef} lessonId={selectedLesson.id} lessonBonusPoints={selectedLesson.bonusPoints || 0} lessonLines={paragraphLessonLines} displayLineNumber={4} notifyLessonEnd={notifyLessonEnd} />
                }
            </div>
